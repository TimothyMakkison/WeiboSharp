...
namespace WeiboSharp.Classes.Android.DeviceInfo
{
    ...
    public class ApiRequestMessage
    {
        ...
        internal string GenerateSignature(WeiboApiVersion apiVersion, string signatureKey, out string deviceid)
        {
        ...
        internal string GenerateChallengeSignature(WeiboApiVersion apiVersion, string signatureKey, string csrfToken, out string deviceid)
        {
            if (string.IsNullOrEmpty(signatureKey))
                signatureKey = apiVersion.SignatureKey;
            var api = new ApiRequestChallengeMessage
