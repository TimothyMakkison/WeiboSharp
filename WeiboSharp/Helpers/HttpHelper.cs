...
namespace WeiboSharp.Helpers
{
    ...
    {
        public /*readonly*/ WeiboApiVersion _apiVersion;
        private readonly Random Rnd = new Random();
        public IHttpRequestProcessor _httpRequestProcessor;
        public IWeiboApi _weiboApi;

        internal HttpHelper(WeiboApiVersion apiVersionType, IHttpRequestProcessor httpRequestProcessor, IWeiboApi weiboApi)
        {
        ...
        public HttpRequestMessage GetDefaultRequest(HttpMethod method, Uri uri, AndroidDevice deviceInfo)
        {
            ...
            var wwwClaim = _weiboApi.GetLoggedUser()?.WwwClaim;
            ...
            var authorization = _weiboApi.GetLoggedUser()?.Authorization;
